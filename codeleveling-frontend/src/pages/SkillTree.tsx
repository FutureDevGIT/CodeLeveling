...
const SkillTree: React.FC<SkillTreeProps> = ({ skills, hoveredSkill, setHoveredSkill, onClose }) => {

  // Memoize SkillNode component to avoid unnecessary re-renders
  const SkillNode = React.memo(({ skill }: { skill: Skill }) => {
    const handleMouseEnter = useCallback(() => setHoveredSkill(skill), [skill, setHoveredSkill]);
